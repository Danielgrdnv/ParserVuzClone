...
namespace Parser
{
    public partial class Form1 : Form
    {
        ...
        private void ButtonStart_Click(object sender, EventArgs e)
        {
            ...
            if (RadioButtonVUZ1.Checked) BUrl = "postupi.online/vuzi/";
            if (RadioButtonProgram2.Checked) BUrl = "postupi.online/programmy-obucheniya/bakalavr/";
            ...
            if (CheckBoxGos_1.Checked) filter += "vuzgos-da/";
            if (CheckBoxArmy_2.Checked) filter += "voenkaf-da/";
            if (CheckBoxDorm_3.Checked) filter += "obshchezhitie-da/";
        ...
        private void RadioButtonVUZ1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            GroupBoxFilterProg3.Visible = false;
        ...
        private void RadioButtonProgram2_CheckedChanged(object sender, EventArgs e)
        {
            LabelProgress.Text = "Прогресс: Парсинг не начат";
        ...
        {
            parser.Abort(); 
            switch (RadioButtonProgram2.Checked) //Чтобы отфильтровать специализации конкретного вуза, необходимо первоначально переключить поиск в "поиск по специализации"
            {
                case true:
